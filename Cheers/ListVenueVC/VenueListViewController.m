...
- (IBAction)CheersLogoAction:(id)sender;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.row !=0){
        ...
        [cell.btLikedOutlet setTitle:[NSString stringWithFormat:@"%@",object[indexPath.row-1][@"Id"]] forState:UIControlStateNormal];
...
- (IBAction)CheersLogoAction:(id)sender {
   ...
   // [self.sideBarButton2 performSelector:@selector(closeMenu)];
